...
class MovieDetail : NSObject, NSCoding{
    ...
    init(fromJson json: JSON!){
        ...
        if !belongsToCollectionJson.isEmpty{
            belongsToCollection = MovieDetailBelongsToCollection(fromJson: belongsToCollectionJson)
        }
        budget = json["budget"].intValue
        genres = [MovieDetailGenre]()
        let genresArray = json["genres"].arrayValue
        for genresJson in genresArray{
            let value = MovieDetailGenre(fromJson: genresJson)
            genres.append(value)
        }
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        belongsToCollection = aDecoder.decodeObject(forKey: "belongs_to_collection") as? MovieDetailBelongsToCollection
        budget = aDecoder.decodeObject(forKey: "budget") as? Int
        genres = aDecoder.decodeObject(forKey: "genres") as? [MovieDetailGenre]
        ...
        productionCompanies = aDecoder.decodeObject(forKey: "production_companies") as? [MovieDetailProductionCompany]
        productionCountries = aDecoder.decodeObject(forKey: "production_countries") as? [MovieDetailProductionCountry]
        ...
        spokenLanguages = aDecoder.decodeObject(forKey: "spoken_languages") as? [MovieDetailSpokenLanguage]
